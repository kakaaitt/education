...
public class Global {
	...
	public static String getSubjectUrl(){
		...
		return  Servlets.getRequest().getContextPath() + Global.USERFILES_BASE_URL + "1/sys/subject/";
	}
	 ...
	 * @return
	 */
	public static String getFileTypeUrl(){

		return  Servlets.getRequest().getContextPath() + Global.USERFILES_BASE_URL + "1/sys/filetype/";
	}
	...
	public static String getUserfilesBaseDir() {
		...
		if (StringUtils.isBlank(dir)){
			try {
				dir = Servlets.getRequest().getServletPath();

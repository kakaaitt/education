					...
					<form id="searchForm" class="form form-horizontal well clearfix" >
						...
						<div class="col-sm-4">
					    	...
					    	<sys:treeselect id="company" name="company.id"
										title="机构" url="/sys/office/treeData?type=1" cssClass=" form-control" allowClear="true"/>
					    </div>
					    <div class="col-sm-4">
					    	<label class="label-item single-overflow pull-left" title="归属分支机构：">归属分支机构：</label>
					   		<sys:treeselect id="office" name="office.id"
								title="分支机构" url="/sys/office/treeData?type=2" cssClass=" form-control" allowClear="true" notAllowSelectParent="true"/>
					    </div>
					    <div class="col-sm-4">
					    	<label class="label-item single-overflow pull-left" title="角色：">角色：</label>
						    <select name="role.id" class="form-control m-b">
						    	<option value=""></option>
...
<%-- 								<form:options path="roleIdList" items="${allRoles}" itemLabel="name" itemValue="id" htmlEscape="false"/> --%>
<%-- 							</form:select> --%>
<!-- 					    </div> -->
					    <div class="col-sm-4">

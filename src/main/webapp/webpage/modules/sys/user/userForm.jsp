		   ...
		   <tbody>
		      <tr>
		         ...
		         <td class="width-35"><sys:treeselect id="company" name="company.id" value="${user.company.id}" labelName="company.name" labelValue="${user.company.name}"
						title="机构" url="/sys/office/treeData?type=1" allowClear="true" cssClass="form-control required"/></td>
		      </tr>
		      ...
		      <tr>
		         ...
		         <td><sys:treeselect id="office" name="office.id" value="${user.office.id}" labelName="office.name" labelValue="${user.office.name}"
					 allowClear="true" title="分支机构" url="/sys/office/treeData?type=2" cssClass="form-control required" notAllowSelectParent="true"/></td>
...
<%-- 		         <td><form:input path="no" htmlEscape="false" maxlength="50" class="form-control required"/></td> --%>
		      ...
		      <tr>
		         ...
		         <td><form:input path="birth" htmlEscape="false" maxlength="20" class="form-control"/></td>
		        <td class="active"><label class="pull-right">地址:</label></td>
		         <td><form:input path="address" htmlEscape="false" maxlength="20" class="form-control"/></td>
		      </tr>

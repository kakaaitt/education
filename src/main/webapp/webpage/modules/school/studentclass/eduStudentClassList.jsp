...
<head>
	...
	<%@include file="eduStudentClassList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">学生分配班级列表</h3>
	</div>
	...
	<div id="search-collapse" class="collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="eduStudentClass" class="form form-horizontal well clearfix">
...
<%-- 				<sys:gridselect url="${ctx}/sys/user/data" id="user" name="user.id" value="${eduStudentClass.user.id}" labelName="user.name" labelValue="${eduStudentClass.user.name}" --%>
<%-- 					title="选择学生" cssClass="form-control required" fieldLabels="学生|备注" fieldKeys="name|remarks" searchLabels="学生|备注" searchKeys="name|remarks" ></sys:gridselect> --%>
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<shiro:hasPermission name="school:studentclass:eduStudentClass:add">
				<button id="add" class="btn btn-primary" onclick="add()">
					<i class="glyphicon glyphicon-plus"></i> 新建
				</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="school:studentclass:eduStudentClass:edit">
			    <button id="edit" class="btn btn-success" disabled onclick="edit()">
	            	<i class="glyphicon glyphicon-edit"></i> 修改
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="school:studentclass:eduStudentClass:del">
				<button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">
	            	<i class="glyphicon glyphicon-remove"></i> 删除
	        	</button>
			</shiro:hasPermission>
<%-- 			<shiro:hasPermission name="school:studentclass:eduStudentClass:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="school:studentclass:eduStudentClass:export">
	        		<button id="export" class="btn btn-warning">
					<i class="fa fa-file-excel-o"></i> 导出
				</button>
			 </shiro:hasPermission> --%>
<%-- 	                 <shiro:hasPermission name="school:studentclass:eduStudentClass:view">
	...
	<!-- 表格 -->
	<table id="eduStudentClassTable"   data-toolbar="#toolbar"></table>

...
<body>
						...
						<div class="row">
							<div class="col-sm-10" >
								<div class="input-search">
									<input id="search_q" value="${eduQuestionTree.textid}" type="hidden" name="">
								</div>
							</div>
						</div>
					</div>
	...
	<div id="toolbar">
		<%-- 	<shiro:hasPermission name="teachmaterial:tmaterialresource:eduMaterialResource:add">
			...
			<shiro:hasPermission name="questionbank:questiontree:eduQuestionTree:del">
				<button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">
	            	<i class="glyphicon glyphicon-remove"></i> 删除
	        	</button>
			</shiro:hasPermission>
 			<shiro:hasPermission name="questionbank:questiontree:eduQuestionTree:import">

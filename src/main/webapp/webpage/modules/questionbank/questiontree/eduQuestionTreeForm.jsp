		...
		<table class="table table-bordered">
		   <tbody>
				...
				<tr>
					...
					<td class="width-35">
						<sys:gridselect isMultiSelected="true" url="${ctx}/school/knowledge/eduKnowledge/data" id="konwledges" name="konwledges.id" value="${eduQuestionTree.konwledges.id}" labelName="konwledges.name" labelValue="${eduQuestionTree.konwledges.name}"
							 title="选择知识点" cssClass="form-control " fieldLabels="知识点|年级|学科" fieldKeys="name|grade|subject" searchLabels="年级|学科" searchKeys="grade|subject" ></sys:gridselect>
					</td>
